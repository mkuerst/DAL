...
do
    ...
    do
        ...
        do
            ...
            echo "tid,loop_in_cs,lock_acquires,lock_hold(ms),total_duration(s),wait_acq(ms),wait_rel(ms),array_size(B)" > "$client_res_file"
            echo "tid,loop_in_cs,lock_acquires,lock_hold(ms),total_duration(s),wait_acq(ms),wait_rel(ms),array_size(B)" > "$orig_res_file"
