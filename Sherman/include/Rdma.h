...
bool createQueuePair(ibv_qp **qp, ibv_qp_type mode, ibv_cq *send_cq,
                     ...
                     uint32_t qpsMaxDepth = 1024, uint32_t maxInlineData = 220);
...
//// Operation.cpp
int pollWithCQ(ibv_cq *cq, int pollNumber, struct ibv_wc *wc, uint64_t addr = 0, uint64_t size = 0, uint64_t val = 0);
